 ...
 * Data: maio de 2025
 * Descrição: Arquivo principal da calculadora financeira.
 * Responsável por exibir o menu, coletar entradas do usuário e chamar as funções definidas em calculadora.c 
 * através dos protótipos em calculadora.h.
 */
...
#include "calculadora.h"
 ...
 int main() {
     ...
     case 2:// Juros Compostos
        ...
        tempo = tempo * 12;// Converte a entrada em meses para que o calculo seja feito
        taxa_de_juros = (taxa_de_juros / 100) / 12;// Converte a entrada de numero inteiro (taxa de juros) em decimal e depois 
        }
     ...
     while(opcao != 6);// Opcao de sair da calculadora
